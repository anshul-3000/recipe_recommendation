...
app = Flask(__name__, static_folder='recipe_recommendation-main\\static', template_folder='recipe_recommendation-main\\templates')

# Load vocabulary and DataFrame
with open('recipe_recommendation-main\\models\\recipe_recommendation_model.pkl', 'rb') as f:
    vocab = pickle.load(f)

df = pd.read_csv('recipe_recommendation-main\\data\\processed\\recipes_processed.csv')
